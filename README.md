...
- ✔️ Emotion recognition using deep learning models  
- ✔️ Uses `face-api.js` (TinyFaceDetector + FaceExpressionNet)  
- ✔️ Smooth UI with gradient background  
